  ...
  selectedCount() { return Object.values(this.selected).filter(Boolean).length; }
		...
		for _, col := range columns {
			...
			if col.Sortable {
				...
				templ_7745c5c3_Var5, templ_7745c5c3_Err = templ.JoinStringErrs(fmt.Sprintf("toggleSort('%s')", col.Key))
				if templ_7745c5c3_Err != nil {
		...
		for _, col := range columns {
			...
			templ_7745c5c3_Var8, templ_7745c5c3_Err = templ.JoinStringErrs(fmt.Sprintf("row['%s'] || ''", col.Key))
			if templ_7745c5c3_Err != nil {
