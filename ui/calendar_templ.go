		...
		for _, week := range weeks {
			...
			for _, day := range week {
				if day == 0 {
					...
					templ_7745c5c3_Var9, templ_7745c5c3_Err = templ.JoinStringErrs(fmt.Sprintf("selected = %d", day))
					if templ_7745c5c3_Err != nil {
					...
					templ_7745c5c3_Var10, templ_7745c5c3_Err = templ.JoinStringErrs(fmt.Sprintf("Select %s", calendarMonthName(year, month)))
					if templ_7745c5c3_Err != nil {
					...
					templ_7745c5c3_Var12, templ_7745c5c3_Err = templ.JoinStringErrs(fmt.Sprintf("selected === %d ? 'bg-primary text-primary-foreground' : ''", day))
					if templ_7745c5c3_Err != nil {
					...
					templ_7745c5c3_Var13, templ_7745c5c3_Err = templ.JoinStringErrs(fmt.Sprintf("selected = %d", day))
					if templ_7745c5c3_Err != nil {
